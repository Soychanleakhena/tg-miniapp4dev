...
//       {/* Main Content */}
//       <main className="absolute bottom-0 left-0 right-0 px-8 pb-10 text-center text-white z-10">
//         <h1 className="text-4xl font-extrabold">FITNESS CLUB.</h1>
//         <p className="text-[#FFD700] font-semibold text-xl tracking-wide mt-2">
//           NO PAIN... NO GAIN
//         </p>
//         <p className="text-xl max-w-[400px] mx-auto leading-relaxed mt-4">
//           Hulk Gym is where strength meets motivation—train with the best, push
//           your limits, and unlock your full potential!
//         </p>
...
//       {/* Gym Image as Background */}
//       <div
//         className="absolute top-0 left-0 right-0 w-full h-full bg-cover bg-center z-0"
...
export default function FitnessClub() {
  ...
  return (
    <div className="min-h-screen w-full  flex flex-col items-center px-0 py-6">
      <div
        className="absolute inset-0 bg-white z-10"
        style={{ clipPath: "polygon(0 0, 100% 0, 100% 40%, 0 60%)" }}
      ></div>
      ...
      <div className="relative z-20 flex flex-col min-h-screen w-full">
        ...
        {/* Main Content */}
        <main className="absolute bottom-6 left-0 right-0 px-0 pb-10 text-center text-white z-10">
          <h1 className="text-4xl font-extrabold">FITNESS CLUB.</h1>
          <p className="text-[#FFD700] font-semibold text-xl tracking-wide mt-2">
            NO PAIN... NO GAIN
          </p>
